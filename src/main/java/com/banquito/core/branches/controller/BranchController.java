...
public class BranchController {
    ...
    @GetMapping("/{code}")
    public ResponseEntity<BranchRQRS> obtainByCode(@PathVariable String code) {
    ...
    @PutMapping("/{code}")
    public  ResponseEntity<BranchRQRS> update(@PathVariable String code, @RequestBody BranchRQRS branch) {
        try {
